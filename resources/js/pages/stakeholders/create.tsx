      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-3xl font-bold tracking-tight">Tambah Stakeholder</h2>
              <p className="text-muted-foreground mt-2">
                Tambahkan stakeholder baru untuk pelaporan emisi
              </p>
            </div>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Lengkapi data stakeholder yang akan ditambahkan
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={submit} className="space-y-6">
                ...
                <div className="flex items-center gap-4 pt-4">
                  <Button type="submit" disabled={processing}>
                    {processing ? 'Menyimpan...' : 'Simpan Stakeholder'}
                  </Button>
                  <Link href="/stakeholders">
