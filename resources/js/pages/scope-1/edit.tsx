...
export default function Edit({ auth, emission, emissionFactors, stakeholders }: Props) {
  const { data, setData, put, processing, errors } = useForm({
    emission_factor_id: emission.emission_factor_id.toString(),
    stakeholder_id: emission.stakeholder_id.toString(),
    measurement_date: emission.measurement_date ? new Date(emission.measurement_date).toISOString().substring(0, 10) : '',
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-3xl font-bold tracking-tight">Edit Emisi Scope 1</h2>
              <p className="text-muted-foreground mt-2">
                Perbarui data emisi langsung dari sumber yang dimiliki atau dikendalikan organisasi
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Perbarui formulir berikut untuk mengubah data emisi Scope 1
                </CardDescription>
              </CardHeader>
